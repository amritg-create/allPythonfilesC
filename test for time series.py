...
import pandas as pd
#dframe = pd.read_excel("C:/Users/amrigupt/Downloads/whole2024ChangeEvents.xlsx")
#dframe


#Creating Panda Profiles Report 

#profile = ProfileReport(df = df)
#profile

#df.profile_report().to_file("04_time_series/profiletest_report.html")

#Creating a separate dataframe with event name and event occur date. 

#dframe[['EVENT_NAME', 'EVENT_OCCUR_DATE']].value_counts()
