...
result = rag_chain.invoke("What was Cisco total revenues in quarter ending January 27, 2024?")
...
result1 = rag_chain.invoke("What were revenues in quarter ending April 27, 2024?")
