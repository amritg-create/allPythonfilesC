...
st.set_page_config(page_title="Your Learning Copilot", layout="wide")
st.title("Your Learning Copilot")
...
def create_rag_chain(api_key):
    ...
    vectorstore = Chroma(
        persist_directory= "Learning_Summarizer/data/chroma_hmp_learning.db",
